...
class UnityCommunication(object):
    ...
    def update_camera(
        self, camera_index, position=[0, 1, 0], rotation=[0, 0, 0], field_view=40
    ):
        """
    ...
    def add_character_camera(
        self, position=[0, 1, 0], rotation=[0, 0, 0], field_view=60, name="new_camera"
    ):
        """
    ...
    def update_character_camera(
        self, position=[0, 1, 0], rotation=[0, 0, 0], field_view=60, name="PERSON_FRONT"
    ):
        """
        ...
        response = self.post_command(
            {
                "id": str(time.time()),
                "action": "update_character_camera",
                "stringParams": [json.dumps(cam_dict)],
            }
        )
        return response["success"], response["message"]
    ...
    def procedural_generation(self, seed=None):
        ...
        """
        response = self.post_command(
            {"id": str(time.time()), "action": "clear_procedural", "intParams": []}
        )
        response = self.post_command(
            {
                "id": str(time.time()),
                "action": "procedural_generation",
    ...
    def remove_terrain(self):
        ...
        """
        response = self.post_command(
            {"id": str(time.time()), "action": "remove_terrain", "intParams": []}
        )
        return response["success"]
