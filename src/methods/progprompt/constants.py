...
- Include ONLY the actions that are strictly necessary to achieve the task goal.
- Optional, comfort-based, or stylistic actions are forbidden unless explicitly required by the task.
