...
ENVIRONMENT_INIT: Callable[[int, str, str, str], str] = (
    lambda env_id, initial_room, task_instruction, log_file_prefix: f"""
log_file = open("{log_file_prefix}/{task_instruction}.txt", "a")
